object WebModule1: TWebModule1
  ...
  object FDConnection1: TFDConnection
    Params.Strings = (
        ...
        'Database=C:\Users\yamat\Documents\GitHub\Parent\auth\data\NEWDAT' +
        'A.GDB'
      'User_Name=sysdba'
      'Password=masterkey'
      'CharacterSet=utF8'
  ...
  object RESTClient1: TRESTClient
    ...
    BaseURL = 'https://api.sssapi.app/mhukY024R56Kuh4rZkPTi'
    Params = <>
  ...
  object FDMemTable1: TFDMemTable
    ...
    object FDMemTable1rank: TFloatField
      FieldName = 'rank'
    end
    ...
    object FDMemTable1active: TBooleanField
      FieldName = 'active'
    end
  end
  object PageProducer10: TPageProducer
    HTMLFile = '.\templates\tables.htm'
    OnHTMLTag = PageProducer10HTMLTag
    Left = 432
    Top = 16
  end
